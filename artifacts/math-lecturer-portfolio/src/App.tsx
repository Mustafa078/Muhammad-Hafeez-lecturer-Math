      ...
      <header className="fixed inset-x-0 top-0 z-50 border-b border-[#d2c7b9]/70 bg-[#f7f3ed]/90 backdrop-blur-xl" data-testid="header-site">
        <div className="section-shell flex h-[76px] items-center justify-between">
          ...
          <nav className="hidden items-center gap-7 md:flex" aria-label="Main navigation">
            ...
            <a href="/m-hafeez-cv-public-placeholder.txt" download className="button-primary ml-2 py-3 text-[10px]" data-testid="link-download-cv-nav">
        ...
        {menuOpen && (
          <div className="border-t border-[#d2c7b9]/70 bg-[#f7f3ed] px-5 py-5 md:hidden" data-testid="menu-mobile">
            <nav className="section-shell flex flex-col gap-1" aria-label="Mobile navigation">
              ...
              <a href="/m-hafeez-cv-public-placeholder.txt" download className="button-primary mt-4 w-fit" data-testid="link-download-cv-mobile"><Download size={14} /> Download CV</a>
            </nav>
          </div>
        )}
      </header>
        ...
        <section id="contact" className="scroll-mt-24 bg-[#4e7c78] py-24 text-[#f7f3ed] sm:py-32" data-testid="section-contact">
          <div className="section-shell grid gap-14 lg:grid-cols-[1.1fr_.9fr] lg:items-end lg:gap-24">
            <Reveal>
              ...
              <a href="/m-hafeez-cv-public-placeholder.txt" download className="mt-9 inline-flex items-center gap-2 border-b border-[#f3e5c2] pb-2 text-sm font-semibold text-[#f3e5c2] transition-colors hover:text-white" data-testid="link-download-cv-contact"><Download size={16} /> Download public-safe CV placeholder</a>
            </Reveal>
            <Reveal delay={140}>
